...
public class AuditContext {
    ...
    public static void setUserName(String userName) { AuditContext.userName.set(userName); }
    public static String getUserName() { return userName.get(); }
    public static void setIpAddress(String ipAddress) { AuditContext.ipAddress.set(ipAddress); }
