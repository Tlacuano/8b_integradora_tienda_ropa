...
public class UserController {
    ...
    ResponseEntity<Object> getPageUsers(Pageable pageable) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(pageUsers, "Usuarios encontrados (page)", false, 200), HttpStatus.OK);
    }
    ...
    ResponseEntity<Object> getPageUsersByEmail(Pageable pageable, @RequestBody RequestActionByEmailDTO email) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(pageUsers, "Usuarios encontrados por email", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> getPageAdmins(Pageable pageable) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(pageUsers, "Usuarios encontrados para admin", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> getPageAdminsByEmail(Pageable pageable, @RequestBody RequestActionByEmailDTO email) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(pageUsers, "Usuarios encontrados para admin por email", false, 200), HttpStatus.OK);
    }

    @PostMapping("/get-by-email")
    public ResponseEntity<Object> getByEmail(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.getByEmail(payload.getEmail()), "Usuario encontrado por email", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> existByEmail(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.existByEmail(payload.getEmail()), "Consulta exitosa", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> getUserDetailByEmailAdmin(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.getUserDetailsByEmailAdmin(payload.getEmail()), "Usuario encontrado para admin por email", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> postAccount(@Validated @RequestBody RequestPostAccountDTO user) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(userService.postAccount(user), "Cuenta registrada correctamente", false, 201), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> postAdminAccount(@Validated @RequestBody RequestPostAccountDTO user) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(userService.postAccount(user), "Cuenta registrada correctamente por admin", false, 201), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> deleteAccount(@Validated @RequestBody RequestRestorePasswordDTO payload) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(true, "Cuenta eliminada correctamente", false, 200), HttpStatus.OK);
    }

    @PostMapping("/put-status")
    public ResponseEntity<Object> putStatus(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.changeStatusAccount(payload), "Estado de cuenta cambiado correctamente", false, 200), HttpStatus.OK);
    }

    @PostMapping("/verify-email")
    public ResponseEntity<Object> verifyCode(@Validated @RequestBody RequestCodeDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.verifyCode(payload), "Código verificado correctamente", false, 200), HttpStatus.OK);
    }

    @PostMapping("/get-profile")
    public ResponseEntity<Object> getProfile(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.getProfile(payload.getEmail()), "Perfil encontrado", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> resendEmailCode(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.resendEmailCode(payload.getEmail()), "Código reenviado correctamente", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> deleteIncompleteAccount(@Validated @RequestBody RequestActionByEmailDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.deleteIncompleteAccount(payload.getEmail()), "Cuenta incompleta eliminada correctamente", false, 200), HttpStatus.OK);
    }

    @PostMapping("/restore-password")
    public ResponseEntity<Object> restorePassword(@Validated @RequestBody RequestRestorePasswordDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.restorePassword(payload), "Contraseña restaurada correctamente", false, 200), HttpStatus.OK);
    }

    @PostMapping("/change-password")
    public ResponseEntity<Object> changePassword(@Validated @RequestBody RequestRestorePasswordDTO payload) {
        return new ResponseEntity<>(new CustomResponse<>(userService.changePassword(payload), "Contraseña cambiada correctamente", false, 200), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> deleteAccountAdmin(@Validated @RequestBody RequestRestorePasswordDTO payload) {
        ...
        return new ResponseEntity<>(new CustomResponse<>(true, "Cuenta eliminada correctamente por admin", false, 200), HttpStatus.OK);
    }
}
