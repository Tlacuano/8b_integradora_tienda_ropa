...
public class WishListController {
    ...
    public ResponseEntity<CustomResponse<List<ResponseWishListDTO>>> findWishListByUserEmail(@Validated @RequestBody Map<String, String> requestBody) {
        List<ResponseWishListDTO> wishList = wishListService.findWishListByUserEmail(requestBody.get("userEmail"));
