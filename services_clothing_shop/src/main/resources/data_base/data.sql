...
VALUES (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860bd6'),
        'Hombres',
        'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713200493/igjex0cvagbrdjwxbr4y.jpg',
        true),
       (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860bd7'),
        'Mujeres',
        '	http://res.cloudinary.com/dq1so9dp8/image/upload/v1713201276/la40n9tfkrdm1hepez94.jpg',
        true),
       (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860bd8'),
        'Niños',
        'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713201651/r91v8biygjr7owfxtpxq.jpg',
        true);
...
VALUES
    ...
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c0e'),
     'QmoRpPBuhU8CdQPybyj3RLuddrqVXqdgnSd%2B2%2FglpG0kfh7klgFvWBq0ntHFO0YB',
     'Elon Musk',
...
-- MUJERES ZAPATOS
    ...
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1c'),
     8,
     'Camiseta de manga corta color negro para niño con estampado de dinosaurio',
     199.99,
...
VALUES
    ...
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c23'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713205058/r63nigf8cwtiotkvxbm9.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c12'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c24'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713205106/xbgbv5jqpbp8v2k97l8i.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c12'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- PANTALON
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c25'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713205536/xiabwm3e9futdfwtfjgi.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c13'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c26'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713205558/nxl4zuybgryub7pw7gy7.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c13'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- CAMISETA
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c27'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713206335/rdn0todfmywsvkj38phs.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c14'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    ...
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c99'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713206465/exkksst1efpnpdrdg9pr.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c14'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- CHAMARRA
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c29'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207586/neajncvrvtha3ukqnswf.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c15'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2a'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207603/hdgam88dxg4ej0sv5aod.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c15'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- ACCESORIO
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2b'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207368/ofphip7w5m2vyzieklqk.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c16'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2c'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207420/xiabndfglgf4mxbzlccz.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c16'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- SELLER 2
    -- BLUSA
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2d'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207917/vo4j4hk2tiu2fwmptuyt.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c17'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2e'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713207892/iusffwfedqwechfjx4tz.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c17'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- FALDA
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c2f'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713208092/vgbmwjaaoyg6tajpekdn.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c18'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c30'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713208110/onoiy2tmsl6pp6syui9z.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c18'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- PANTALON
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c31'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713211324/fasrohmcpfb9anmcjcnp.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c19'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c32'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713211345/horuenuqnhlciwnpxqal.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c19'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- VESTIDO
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c33'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713211652/fhqtw7a20s0ex4bdrfhf.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1a'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c34'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713211633/gro5nfnix2ejnnkpvsb8.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1a'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- ZAPATOS
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c35'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713211980/okbehchu623qiwnrvf1s.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1b'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c36'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713212007/tjt0adhjoprrzxcevfrl.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1b'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- NIÑOS CAMISETA
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c37'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713212701/jspmosiguoflqdwrttrf.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1c'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c38'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713212741/fdipfjw0jtqpzl5tdiqf.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1c'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- NIÑOS PANTALON
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c39'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713213066/hipiakhznu5uvchvqqcp.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1d'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    ...
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c3b'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713213310/dqvxbr8dcy8cxv3wya10.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1e'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c3c'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713213329/znihv4gbm7ua8aknweau.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1e'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20')),
    -- NIÑOS ACCESORIO
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c3d'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713213517/ayw4xnz4xg7bftxo9fkd.png',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1f'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c22')),
    (UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c3e'),
     'http://res.cloudinary.com/dq1so9dp8/image/upload/v1713213553/vxlwbeufwvciqqvjhdrm.jpg',
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c1f'),
     UUID_TO_BIN('ed08f0eb-ec02-11ee-b34f-d85ed3860c20'));
