<template>
  <b-modal id="put-personal-information-profile-modal" hide-header hide-footer centered @shown="getPersonalInformation">
    <b-container>
        ...
        <section v-if="page === 1" >
          <b-row>
            <b-col class="text-right">
              <font-awesome-icon icon="times" class="selectable text-secondary" @click="$bvModal.hide('put-personal-information-profile-modal')"/>
            </b-col>
          </b-row>
          <b-row class="mt-3">
...
export default {
  name: 'PutPersonalInformationProfileModal',
  data() {
    return {
      page: 1,
