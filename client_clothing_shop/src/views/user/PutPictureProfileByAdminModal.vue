<template>
  <b-modal id="put-picture-profile-by-admin-modal" hide-header centered hide-footer @hidden="resetModal">
    <b-container>
      <b-overlay :show="showOverlay">
        <b-row>
          <b-col class="text-right">
            <font-awesome-icon icon="times" class="text-secondary selectable" @click="$bvModal.hide('put-picture-profile-by-admin-modal')"/>
          </b-col>
        </b-row>
        <b-row class="mt-3">
...
export default {
  name: 'PutPictureProfileByAdminModal',
  props: {
    email: {
      type: String,
      required: true
